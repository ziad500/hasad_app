...
class ImagesManager {
  ...
  static String smallLogo = "$imagesPath/smallLogo.png";
  static String checkoutSuccess = "$imagesPath/checkoutSuccess.png";
}
...
class SVGManager {
  ...
  static String camera = "$svgPath/camera.svg";
  static String files = "$svgPath/files.svg";
  ...
  static String stc = "$svgPath/STC.svg";
  static String cardAdd = "$svgPath/cardAdd.svg";
