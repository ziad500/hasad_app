...
class _WalletAppServiceClient implements WalletAppServiceClient {
  _WalletAppServiceClient(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<StchRechargeResponse> getPaymentLink(String value2) async {
    ...
    final value = StchRechargeResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<SuccessResponse> collectMoney() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
